...
// remmber a provider can be changenotifier or valueNotifier
class ObjectProvider extends ChangeNotifier {
  ...
  // overriding notifyListeners, why..
  // so that whenever we call notifylisteners(), we will reset our id field
  @override
  ...
  void start() {
    _cheapObjectStreamSubs = Stream.periodic(
      ...
      // eg making an API call and storing inside a provider
      _cheapObject = CheapObject();
      notifyListeners();
    });
